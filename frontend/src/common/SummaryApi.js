...
const SummaryApi = {
    ...
    SuratJalan: {
        url: '/api/order/:orderId/surat-jalan', 
        method: "put"
    },
    ApproveOrder : {
        url: '/api/order/approve-items',
        method: 'put'
    },  
   OrderDetail : {
   ...
   UpdateApproveQty : {
        url : '/api/order//:orderId/update-approved-qty',
        method : 'put'
   },
   AddsuratJalan : {
        url : '/api/surat-jalan/add',
        method : 'post'
   },
   EditsuratJalan : {
        url : '/api/surat-jalan/edit/:orderId',
        method : 'put'
   },
//    getSuratJalanByOrderId : {
//         url : '/api/surat-jalan/order/:orderId',
//         method : 'get'
//    },
