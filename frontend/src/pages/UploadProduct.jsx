            ...
            <form className='grid gap-4' onSubmit={handleSubmit}>
                ...
                <div className='grid gap-1'>
                  ...
                  <div>
                    ...
                    >
                      <option value={""} className='text-neutral-600'>Pilih Sub Kategori</option>
                      {
                ...
                <div className='grid gap-1'>
                  <label htmlFor='stock' className='font-medium'>Stok</label>
                  <input 
                    id='stock'
                    type='number'
                ...
                <div onClick={()=>setOpenAddField(true)} className=' hover:bg-primary-200 bg-white py-1 px-3 w-42 text-center font-semibold border border-primary-200 hover:text-neutral-900 cursor-pointer rounded'>
                  Tambah Kolom
                </div>
